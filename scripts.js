...
// Blog Articles
const articles = [
    { title: "Nairobi's Best Expat Neighborhoods for Families", tag: "Neighborhoods", category: "neighborhood", image: "images/neighborhood_blog_1.jpg", date: "Oct 25, 2025" },
    { title: "The Ultimate Checklist for Your Move to Kenya", tag: "Expat Life", category: "expat", image: "images/expat_blog_1.jpg", date: "Oct 18, 2025" },
    { title: "Buying Property: Legal Hurdles for Foreigners in Kenya", tag: "Legal Guide", category: "legal", image: "images/legal_blog_1.jpg", date: "Oct 10, 2025" },
    { title: "Kitisuru vs. Runda: A Comparative Guide", tag: "Neighborhood Guide", category: "neighborhood", image: "images/neighborhood_blog_2.jpg", date: "Sep 28, 2025" },
    { title: "Understanding M-Pesa: Your Digital Wallet in Nairobi", tag: "Expat Finances", category: "expat", image: "images/expat_blog_2.jpg", date: "Sep 15, 2025" },
    { title: "How to Secure Your First Investment in Nairobi Real Estate", tag: "Legal & Finance", category: "legal", image: "images/legal_blog_2.jpg", date: "Sep 1, 2025" },
];
...
function renderArticles(filterCategory = 'all') {
    ...
    filteredArticles.forEach(article => {
        ...
        articleLink.href = `#article-${article.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`; 
    ...
    filteredStudies.forEach(study => {
        ...
        storyCard.innerHTML = `
            ...
            <div class="story-summary">
                <p>Read the full story of how we achieved this result...</p>
            </div>
        `;
...
async function fetchRate() {
  try {
    // Note: The CORS policy on the live API might block this call in a local file.
    // If it fails, the 'fetchRate failed' message will appear.
...
function initBookingForm() {
    ...
    serviceOptions.forEach(card => {
        card.addEventListener('click', () => {
            ...
            // Enable the next button immediately on selection.
